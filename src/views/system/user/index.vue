          ...
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用户密码" prop="password">
              <el-input v-model="form.password"
                        ...
                        placeholder="请输入用户密码" type="password" maxlength="20" show-password/>
              <div style="position: absolute">
                <verify-pass-word-tip :password="form.password" :isShowTip="isShowTip" ref="data"
...
export default {
  ...
  components: { Treeselect, verifyPassWordTip },
  data() {
    return {
      isShowTip: false,
      // 遮罩层
